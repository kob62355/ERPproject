...
function preview(income_id){
            ...
            $.ajax({
               ...
               success:function(data) {
                ...
                $("#tbody").append("<tr><td rowspan=\"3\" colspan=\"3\"><p>ชำระผ่านทาง</p><p style=\"width: 450px; display: table;\"><span style=\"display: table-cell; width: 30px;\"><input type=\"checkbox\" name=\"getmoney\" class=\"radio\" value=\"cash\" disabled></span><span style=\"display: table-cell; width: 120px;\"><label> เงินสด</label><label style=\"margin-left: 5px\">จำนวน</label></span><span style=\"display: table-cell; border-bottom: 1px solid black;margin-top: -4mm\"></span><span style=\"display: table-cell; width: 50px;\"><label style=\"margin-left: 5px\">บาท</label></span></p><p style=\"width: 450px; display: table;\"><span style=\"display: table-cell; width: 30px;\"><input type=\"checkbox\" name=\"getmoney\" class=\"radio\" value=\"transfer\" disabled></span><span style=\"display: table-cell; width: 120px;\"><label> เงินโอน</label><label style=\"margin-left: 5px\">จำนวน</label></span><span style=\"display: table-cell; border-bottom: 1px solid black;margin-top: -4mm\"></span><span style=\"display: table-cell; width: 50px;\"><label style=\"margin-left: 5px\">บาท</label></span></p><p style=\"width: 450px; display: table;\"><span style=\"display: table-cell; width: 30px;\"><input type=\"checkbox\" name=\"getmoney\" class=\"radio\" value=\"check\" disabled></span><span style=\"display: table-cell; width: 120px;\"><label> เช็ค</label><label style=\"margin-left: 5px\">จำนวน</label></span><span style=\"display: table-cell; border-bottom: 1px solid black;margin-top: -4mm\"></span><span style=\"display: table-cell; width: 50px;\"><label style=\"margin-left: 5px\">บาท</label></span></p></td><td>VATABLE</td><td>"+numberWithCommas(vatable)+"</td></tr><tr><td>VAT 7%</td><td>"+ numberWithCommas(vat) +"</td></tr><tr><td>ราคารวมทั้งสิ้น</td><td>"+numberWithCommas(netprice)+"</td></tr>");
